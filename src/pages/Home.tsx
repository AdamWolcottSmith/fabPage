...
const Home = () => {
  ...
  useSEO({
    ...
    description:
      "Corporate stages, film sets, and gallery installations — built to spec, on time. Brooklyn-based Creative Technical Director specializing in CNC fabrication, scenic design, and large-scale builds for events, film/TV, and art.",
    keywords: [
      "fabrication",
      "technical director",
      "production design",
      ...
      <section className="border-b-3 border-brutal-border">
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-24">
          ...
          <h1 className="mb-6 text-5xl font-bold uppercase leading-none md:text-6xl lg:text-7xl">
            THE THING YOU IMAGINED, BUILT.
          </h1>

          {/* Subheadline - muted color, regular weight */}
          <p className="max-w-2xl text-lg text-brutal-muted md:text-xl">
            Corporate events, film sets, and gallery installations — the same
            precision, different stages.
          </p>
        </div>
      </section>
